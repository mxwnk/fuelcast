...
const DICT = {
  en: {
    ...
    "mode.auto": "Auto",
    "mode.build": "Build",
    "build.total": "Race total",
    "build.gels": "Gels",
    "build.bottles": "Bottles",
    "build.overviewTitle": "Race overview",
    "build.goal": "Goal {g} g",
    "build.stillNeeded": "{g} g still needed",
    "build.over": "{g} g over goal",
    "build.met": "Goal reached",
    "build.addGel": "Add gel",
    "build.addBottle": "Add bottle",
    "build.gel": "Gel",
    "build.bottle": "Bottle",
    "build.count": "Count",
    "build.carbs": "Carbs per item",
    "build.volume": "Volume",
    "build.remove": "Remove item",
  ...
  de: {
    ...
    "mode.label": "Planungsmodus",
    "mode.auto": "Auto",
    "mode.build": "Build",
    "build.total": "Renn-Gesamt",
    "build.gels": "Gels",
    "build.bottles": "Flaschen",
    "build.overviewTitle": "Renn-Überblick",
    "build.goal": "Ziel {g} g",
    "build.stillNeeded": "noch {g} g",
    "build.over": "{g} g über Ziel",
    "build.met": "Ziel erreicht",
    "build.addGel": "Gel hinzufügen",
    "build.addBottle": "Flasche hinzufügen",
    "build.gel": "Gel",
    "build.bottle": "Flasche",
    "build.count": "Anzahl",
    "build.carbs": "Kohlenhydrate pro Stück",
    "build.volume": "Volumen",
